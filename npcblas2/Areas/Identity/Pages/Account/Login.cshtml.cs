...
namespace npcblas2.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            // I'm disabling internal logins for this site by replacing the rest of the body
            // of this standard method.  The original is in the Git history; it was scaffolded
